...
const Contact = () => {
  ...
  const contactInfo = [
    {
      ...
      value: "hbasseim8@gmail.com",
      href: "mailto:hbasseim8@gmail.com",
      description: isRTL
        ? "راسلنا في أي وقت وسنرد عليك خلال 24 ساعة"
        : "Email us anytime and we will respond within 24 hours",
    },
    {
      icon: PhoneIcon,
      title: t("contact.info.phone"),
      value: "+964 782 609 0592",
      href: "tel:+9647820592",
      description: isRTL
        ? "اتصل بنا للحصول على استشارة فورية"
        : "Call us for immediate consultation",
    },
    {
      icon: MapPinIcon,
      title: isRTL ? "الموقع" : "Location",
      value: isRTL ? "العراق , بغداد" : "Iraq, Baghdad",
      href: "#",
      description: isRTL
        ? "مكتبنا الرئيسي في قلب العاصمة"
        : "Our main office in the heart of the capital",
    },
  ];
  ...
  const socialLinks = [
    {
      name: "WhatsApp",
      href: "https://wa.me/9647826090592",
      icon: (
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      console.log("Form data:", { ...data, language: i18n.language });
            ...
            >
              ...
              <div className="space-y-8">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <div className="w-12 h-12 bg-gradient-to-r from-primary-900 to-primary-600 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.9 }}
                      className={`w-12 h-12 bg-secondary-100 rounded-lg flex items-center justify-center text-gray-600 transition-all duration-200 ${social.color}`}
                    >
                      {social.icon}
                    </motion.a>
                  ))}
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <motion.button
                  ...
                  className={`w-full flex items-center justify-center px-6 py-4 rounded-lg font-semibold transition-all duration-200 ${
                    isSubmitting
                      ...
                      : "bg-primary-900 hover:bg-primary-800 transform hover:shadow-lg"
                  } text-white`}
                >
                  {isSubmitting ? (
                    <>
                ...
                {submitStatus === "success" && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="flex items-center p-4 bg-success-50 border border-success-200 rounded-lg text-success-800"
                  >
